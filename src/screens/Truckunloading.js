...
const Truckunloading = ({ loader, scanner, barcodeoutnumber }) => {
    const [barcodeno, setBarcodeNumber] = useState(barcodeoutnumber)
    ...
    useEffect(() => {
        setBarcodeNumber(barcodeoutnumber)
